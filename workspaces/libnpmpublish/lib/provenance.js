...
const BUILDKITE_BUILDER_ID_PREFIX = 'https://buildkite.com/agents'
const BUILDKITE_BUILD_TYPE = 'https://buildkite.github.io/slsa-buildtypes/job/v1'
...
const generateProvenance = async (subject, opts) => {
  ...
  if (ci.BUILDKITE) {
    ...
    payload = {
      ...
      predicate: {
        buildDefinition: {
          buildType: BUILDKITE_BUILD_TYPE,
          externalParameters: {
            workflow: {
              ref: workflowRef,
